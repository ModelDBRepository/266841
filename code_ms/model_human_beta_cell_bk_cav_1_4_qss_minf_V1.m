...
function xdot=model_human_beta_cell_bk_cav_1_4_qss_minf(t,x,flag)

% Human beta-cell model with 1:4 BK-CaV complexes. The I_BK current is modeled by
...
n_ca=4; % number of CaV (n_CaV) for BK-CaV complex
h_ca=hCaL;
h_1=nchoosek(n_ca,1)*h_ca.*(1-h_ca).^(n_ca-1);
h_2=nchoosek(n_ca,2)*h_ca.^2.*(1-h_ca).^(n_ca-2);
h_3=nchoosek(n_ca,3)*h_ca.^3.*(1-h_ca).^(n_ca-3);
h_4=nchoosek(n_ca,4)*h_ca.^4.*(1-h_ca).^(n_ca-4);
yL=h_1*mBK_1_L+h_2*mBK_2_L+h_3*mBK_3_L+h_4*mBK_4_L; % BK coupled with L-type

yPQ=mBK_4_PQ; % BK coupled with P/Q-type
...
h_3=nchoosek(n_ca,3)*h_ca.^3.*(1-h_ca).^(n_ca-3);
h_4=nchoosek(n_ca,4)*h_ca.^4.*(1-h_ca).^(n_ca-4);
yT=h_1*mBK_1_T+h_2*mBK_2_T+h_3*mBK_3_T+h_4*mBK_4_T; % BK coupled with T-type
...
mBK_3_L_dot=-k2_ca_c*cccy+k1_ca_o*(3*m_inf*(1-m_inf)^2-ccoy)-k2_ca_o*ccoy-k2_2ca_o*cooy+k1_2ca_o*(3*m_inf^2*(1-m_inf)-cooy)-k2_3ca_o*oooy+k1_3ca_o*(m_inf^3-oooy);
...
mBK_4_L_dot=-k2_ca_c*ccccy+k1_ca_o*(4*m_inf*(1-m_inf)^3-cccoy)-k2_ca_o*cccoy-k2_2ca_o*ccooy+k1_2ca_o*(6*m_inf^2*(1-m_inf)^2-ccooy)-k2_3ca_o*coooy+k1_3ca_o*(4*m_inf^3*(1-m_inf)-coooy)-k2_4ca_o*ooooy+k1_4ca_o*(m_inf^4-ooooy);
...
mBK_3_PQ_dot=-k2_ca_c*cccy+k1_ca_o*(3*m_inf*(1-m_inf)^2-ccoy)-k2_ca_o*ccoy-k2_2ca_o*cooy+k1_2ca_o*(3*m_inf^2*(1-m_inf)-cooy)-k2_3ca_o*oooy+k1_3ca_o*(m_inf^3-oooy);
...
mBK_4_PQ_dot=-k2_ca_c*ccccy+k1_ca_o*(4*m_inf*(1-m_inf)^3-cccoy)-k2_ca_o*cccoy-k2_2ca_o*ccooy+k1_2ca_o*(6*m_inf^2*(1-m_inf)^2-ccooy)-k2_3ca_o*coooy+k1_3ca_o*(4*m_inf^3*(1-m_inf)-coooy)-k2_4ca_o*ooooy+k1_4ca_o*(m_inf^4-ooooy);
...
mBK_3_T_dot=-k2_ca_c*cccy+k1_ca_o*(3*m_inf*(1-m_inf)^2-ccoy)-k2_ca_o*ccoy-k2_2ca_o*cooy+k1_2ca_o*(3*m_inf^2*(1-m_inf)-cooy)-k2_3ca_o*oooy+k1_3ca_o*(m_inf^3-oooy);
...
mBK_4_T_dot=-k2_ca_c*ccccy+k1_ca_o*(4*m_inf*(1-m_inf)^3-cccoy)-k2_ca_o*cccoy-k2_2ca_o*ccooy+k1_2ca_o*(6*m_inf^2*(1-m_inf)^2-ccooy)-k2_3ca_o*coooy+k1_3ca_o*(4*m_inf^3*(1-m_inf)-coooy)-k2_4ca_o*ooooy+k1_4ca_o*(m_inf^4-ooooy);
...
xdot=[v_dot;mkv_dot;hNa_dot;hCaL_dot;hCaT_dot;xERG_dot;yERG_dot;mBK_1_L_dot;mBK_1_PQ_dot;mBK_1_T_dot;mBK_2_L_dot;mBK_2_PQ_dot;mBK_2_T_dot;...
    mBK_3_L_dot;mBK_3_PQ_dot;mBK_3_T_dot;mBK_4_L_dot;mBK_4_PQ_dot;mBK_4_T_dot];